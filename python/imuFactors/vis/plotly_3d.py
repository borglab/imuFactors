...
def plot_3d_trajectory(
    ...
    fig.add_trace(go.Scatter3d(
        x=ground_truth.position[gt_idx, 0],
        y=ground_truth.position[gt_idx, 1],
        z=ground_truth.position[gt_idx, 2],
        mode='lines',
        name='Ground Truth',
    ...
    if predicted is not None:
        ...
        fig.add_trace(go.Scatter3d(
            x=predicted.position[pred_idx, 0],
            y=predicted.position[pred_idx, 1],
            z=predicted.position[pred_idx, 2],
            mode='lines+markers',
            name='Predicted',
    ...
    # Start point
    fig.add_trace(go.Scatter3d(
        x=[ground_truth.position[0, 0]],
        y=[ground_truth.position[0, 1]],
        z=[ground_truth.position[0, 2]],
        mode='markers',
        name='Start',
        marker=dict(
            size=10, 
    ...
    # End point
    fig.add_trace(go.Scatter3d(
        x=[ground_truth.position[-1, 0]],
        y=[ground_truth.position[-1, 1]],
        z=[ground_truth.position[-1, 2]],
        mode='markers',
        name='End',
        marker=dict(
            size=10, 
